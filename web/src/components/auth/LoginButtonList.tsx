...
export const LoginButtonList: React.FC<React.HTMLProps<HTMLDivElement>> = (props) => {
  ...
  return (
    <div {...props}>
      <button
        className="w-64 mt-6 flex items-center rounded shadow text-white focus:outline-none focus:shadow-outline border-2 animate-rise"
        style={{ backgroundColor: '#4285F4', borderColor: '#4285F4' }}
        onClick={() => dispatch(googleSignIn())}
      >
        <span className="bg-white px-6 py-2 rounded">
          <svg
        ...
        <span className="py-2 px-2 w-full">Google</span>
      </button>
      <button
        className="w-64 mt-4 flex items-center rounded shadow text-white focus:outline-none focus:shadow-outline border-2"
        style={{ backgroundColor: '#1877f2', borderColor: '#1877f2' }}
      >
        <span className="py-2 px-6 bg-white rounded">
        ...
        <span className="py-2 px-2 w-full">Facebook</span>
      </button>
    </div>
  );
};
